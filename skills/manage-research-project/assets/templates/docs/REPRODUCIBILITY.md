...
## Project root and path policy

- Canonical root: project-relative; machine-specific root is configurable.
- Hard-coded absolute paths: TODO: none / list unresolved files.
...
- Workflow/backend lock: {{BACKEND_LOCK}}

## Reference resources

| Resource | Version/release | Query/download date | Local path | Used by |
|---|---|---|---|---|
| TODO | TODO | TODO | TODO | TODO |

## Randomness and parallelism

| Stage | Seed | Parallel settings | Deterministic caveat |
|---|---|---|---|
| TODO | TODO | TODO | TODO |
